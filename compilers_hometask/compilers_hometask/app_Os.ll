...
for.body4:                                        ; preds = %for.cond1.preheader, %if.end152
  ...
  %1 = load i8, ptr %arrayidx10, align 1, !range !7, !noundef !8
  ...
  %3 = load i8, ptr %arrayidx19, align 1, !range !7, !noundef !8
  ...
  %4 = load i8, ptr %arrayidx36, align 1, !range !7, !noundef !8
  ...
  %6 = load i8, ptr %arrayidx50, align 1, !range !7, !noundef !8
  ...
  %7 = load i8, ptr %arrayidx64, align 1, !range !7, !noundef !8
  ...
  %8 = load i8, ptr %arrayidx82, align 1, !range !7, !noundef !8
  ...
  %9 = load i8, ptr %arrayidx96, align 1, !range !7, !noundef !8
  ...
  %10 = load i8, ptr %arrayidx114, align 1, !range !7, !noundef !8
  ...
  %11 = load i8, ptr %arrayidx127, align 1, !range !7, !noundef !8
...
for.cond.cleanup3:                                ; preds = %for.body4
  ...
  br i1 %exitcond27.not, label %for.cond.cleanup, label %for.cond1.preheader, !llvm.loop !10
...
for.body4:                                        ; preds = %for.cond1.preheader, %for.body4
  ...
  %1 = getelementptr inbounds [256 x i8], ptr %frame, i64 %indvars.iv, i64 %indvars.iv24
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 131072, ptr nonnull %current_data) #7
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(131072) %current_data, i8 0, i64 131072, i1 false)
  call void @llvm.lifetime.start.p0(i64 131072, ptr nonnull %prev_data) #7
...
for.cond.cleanup3.i:                              ; preds = %for.body4.i
  ...
  br i1 %exitcond27.not.i, label %for.cond2.preheader, label %for.cond1.preheader.i, !llvm.loop !10
...
for.body4.i:                                      ; preds = %for.body4.i, %for.cond1.preheader.i
  ...
  %1 = getelementptr inbounds [256 x i8], ptr %prev_data, i64 %indvars.iv.i, i64 %indvars.iv24.i
...
for.cond2.preheader:                              ; preds = %for.cond.cleanup3.i, %for.cond2.preheader.backedge
  ...
  %3 = trunc nuw nsw i64 %indvars.iv57 to i32
  br label %for.body5

for.cond.cleanup:                                 ; preds = %for.cond.cleanup4
  call void @cell_process(ptr noundef nonnull %prev_data, ptr noundef nonnull %current_data) #8
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.inc
  ...
  %4 = load i8, ptr %arrayidx7, align 1, !range !7, !noundef !8
  %loadedv = trunc nuw i8 %4 to i1
  %5 = trunc nuw nsw i64 %indvars.iv to i32
  br i1 %loadedv, label %if.then, label %if.else

if.then:                                          ; preds = %for.body5
  tail call void @simPutPixel(i32 noundef %5, i32 noundef %3, i32 noundef -16733441) #6
  br label %for.inc

if.else:                                          ; preds = %for.body5
  tail call void @simPutPixel(i32 noundef %5, i32 noundef %2, i32 noundef 0) #6
  br label %for.inc

for.inc:                                          ; preds = %if.then, %if.else
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 512
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !13
...
for.cond.cleanup21:                               ; preds = %for.body22
  ...
  br i1 %cmp15.not, label %for.cond.cleanup16, label %for.cond19.preheader, !llvm.loop !14
...
for.body22:                                       ; preds = %for.cond19.preheader, %for.body22
  ...
  %6 = load i8, ptr %arrayidx26, align 1, !range !7, !noundef !8
  ...
  br i1 %cmp20.not, label %for.cond.cleanup21, label %for.body22, !llvm.loop !15
}
